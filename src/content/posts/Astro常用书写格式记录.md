...
<div class="tab-container">
	...
	<div class="tab-content" data-tab="tab4">
		<p> ![示例](https://gcore.jsdelivr.net/gh/Keduoli03/My_img@img/E8uWFJnVcAIMcOB.jpg)</p>
	</div>
</div>
<style>
	input[type="radio"] {
	...
	input[type="radio"]: checked + label {
		background: white;
		color: #ff5a5f ;
		box-shadow: 0 -3 px 0 #ff5a5f inset;
		border-color: #ddd ;
		font-weight: 500;
	}
	.tab-content {
	...
	#tab1 : checked ~ [data-tab="tab 1"],
	#tab2 : checked ~ [data-tab="tab 2"],
	#tab3 : checked ~ [data-tab="tab 3"],
	#tab4 : checked ~ [data-tab="tab 4"] {
		display: block;
